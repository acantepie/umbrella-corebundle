const TRANS = {
    ...
    ru: {
        ...
        'forbidden_error': 'У Вас нет прав не выполнение этого действия',
        'notfound_error': 'Не удается подключиться к серверу',
        'other_error' : 'Произошла ошибка',
        'loading_data_error': 'Не удается загрузить данные'
    },
}
